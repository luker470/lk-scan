...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const result = await normalizeAllExistingMangas(db);
    ...
    console.error("POST /api/admin/normalize-mangas error:", error);

    const message =
      error instanceof Error ? error.message : "Erro ao normalizar mangás.";
